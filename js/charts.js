...
EF.charts = (function () {
  const instances = {};
  const COLORS = {
    gold: '#E8B23A', goldBright: '#FFD873', green: '#3FCE97', red: '#F03E68', redBright: '#FF6B8E',
    blue: '#5B8CFF', purple: '#B87CFF', grid: '#2E2A3A', text: '#ACA5B3'
  };
  const PALETTE = ['#E8B23A', '#F03E68', '#FFD873', '#5B8CFF', '#FF6B8E', '#3FCE97', '#B87CFF', '#8C6F2E'];
